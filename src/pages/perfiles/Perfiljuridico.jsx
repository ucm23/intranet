...
import Descargajuridico from '../../componentesdescarga/Descargajuridico';


const Perfiljuridico = () => {
      ...
      <div className="container">
        <div className="leftContainer">
          ...
          <div>
            ...
            <span style={{ textAlign: 'center', color: 'white', fontSize: '12px', marginLeft: '14px', fontFamily: 'customFont' }}>Luis Manuel Alfaro Rivera</span>
            ...
            <p style={{ color: 'white', fontSize: '12px', marginLeft: '18px', fontFamily: 'customFont' }}>Lalfaro@consultores-cti.com.mx</p>
            <p></p>
            <FontAwesomeIcon icon={faPhone} style={{ color: 'white', marginLeft: '20px', height: '15px', width: '15px' }} /> {/* Icono Font Awesome */}
            <span style={{ textAlign: 'center', color: 'white', fontSize: '12px', marginLeft: '14px', fontFamily: 'customFont' }}>Telefono: 2361039980</span> {/* Texto */}
            ...
            <p style={{ color: 'black', fontSize: '2px', marginLeft: '5px', fontFamily: 'customFont' }}> .</p>
