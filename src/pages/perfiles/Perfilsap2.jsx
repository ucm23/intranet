            ...
            <div className="container">
                <div className="leftContainer">
                    ...
                    <div>
                        ...
                        <span style={{ textAlign: 'center', color: 'white', fontSize: '12px', marginLeft: '16px', fontFamily: 'customFont' }}>Frank Mejía  </span><br></br>
                        ...
                        <p style={{ color: 'white', fontSize: '12px', marginLeft: '16px', fontFamily: 'customFont' }}>fmejía@consultores-cti.com.mx</p>
                        <p></p>
