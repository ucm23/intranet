      ...
      <div className="container">
        <div className="leftContainer">
          ...
          <div>
            ...
            <span style={{ textAlign: 'center', color: 'white', fontSize: '13px', marginLeft: '18px', fontFamily: 'customFont' }}>Pablo Tlaxcoapan</span><br></br>
            ...
            <p style={{ color: 'white', fontSize: '12px', marginLeft: '18px', fontFamily: 'customFont' }}>pablo.tlaxcoapan@aiformers.com</p>
            <p></p>
            ...
            <p style={{ color: 'white', fontSize: '12px', marginLeft: '50px', fontFamily: 'customFont' }}>7223502242</p>
            <p></p>
