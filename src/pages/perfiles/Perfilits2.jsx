      ...
      <div className="container">
        <div className="leftContainer">
          ...
          <div>
            ...
            <span style={{ textAlign: 'center', color: 'white', fontSize: '11px', marginLeft: '5px', fontFamily: 'customFont' }}>Julio César Castillo Z.</span><br></br>
            ...
            <p style={{ color: 'white', fontSize: '12px', marginLeft: '18px', fontFamily: 'customFont' }}>jcastillo@consultores-cti.com.mx</p>
            <p></p>
