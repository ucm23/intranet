            ...
            <div className="container">
                <div className="leftContainer">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}> {/* Usando Flexbox para alinear en fila */}
                        ...
                        {/* <img src={`../../imgOrganigrama/${nombreImagen}`} alt="Imagen" /> */}
                        <img
                            // src={`../../imgOrganigrama/${nombreImagen}`}
                ...
                <div className="rightContainer">
                    ...
                    <p style={{ color: 'black', fontSize: '15px', marginLeft: '30px', fontFamily: 'customFont', fontWeight: 'bold' }}> Capacitación:</p>
                    <p style={{ color: 'black', fontSize: '13px', marginLeft: '25px', marginRight: '25px', fontFamily: 'Roboto, sans-serif', textAlign: 'justify' }}>
