      ...
      <div className="container">
        <div className="leftContainer">
          ...
          <div>
            ...
            <span style={{ textAlign: 'center', color: 'white', fontSize: '12px', marginLeft: '2px', fontFamily: 'customFont' }}>Antonia Cortés Pérez</span><br></br>
            ...
            <p style={{ color: 'white', fontSize: '12px', marginLeft: '18px', fontFamily: 'customFont' }}>acortes@consultores-cti.com.mx</p>
            <p></p>
