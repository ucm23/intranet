      ...
      <div className="container">
        <div className="leftContainer">
          ...
          <div>
            ...
            <span style={{ textAlign: 'center', color: 'white', fontSize: '13px', marginLeft: '18px', fontFamily: 'customFont' }}>Ulises Cano Martínez</span>
            ...
            <p style={{ color: 'white', fontSize: '12px', marginLeft: '18px', fontFamily: 'customFont' }}>ucano@consultores-cti.com.mx</p>
            <p></p>
