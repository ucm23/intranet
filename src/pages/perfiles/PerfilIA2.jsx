      ...
      <div className="container">
        <div className="leftContainer">
          ...
          <div>
            ...
            <span style={{ textAlign: 'center', color: 'white', fontSize: '13px', marginLeft: '18px', fontFamily: 'customFont' }}>Josue Tlaxcoapan</span><br></br>
            ...
            <p style={{ color: 'white', fontSize: '12px', marginLeft: '18px', fontFamily: 'customFont' }}>josue.tlaxcoapan@aiformers.com</p>
            <p></p>
