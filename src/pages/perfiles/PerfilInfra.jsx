      ...
      <div className="container">
        <div className="leftContainer">
          ...
          <div>
            ...
            <span style={{ textAlign: 'center', color: 'white', fontSize: '12px', marginLeft: '7px', fontFamily: 'customFont' }}>Heber Argumedo</span><br></br>
            ...
            <p style={{ color: 'white', fontSize: '12px', marginLeft: '18px', fontFamily: 'customFont' }}>hargumedo@consultores-cti.com.mx</p>
            <p></p>
