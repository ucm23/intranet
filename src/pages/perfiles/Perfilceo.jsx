                ...
                <div className="leftContainer">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}> {/* Usando Flexbox para alinear en fila */}
                        <img
                            ...
                            style={{ borderRadius: '0%', cursor: 'pointer', width: '70%', height: '60%', objectFit: 'cover', marginLeft: '25px', marginTop: '20px' }}
                        // Estilo de la imagen
                        />
                    ...
                    <div>
                        ...
                        <span style={{ textAlign: 'center', color: 'white', fontSize: '12px', marginLeft: '16px', fontFamily: 'customFont' }}>Guillermina Sámano Gaspar</span>
