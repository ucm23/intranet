        ...
        <div style={{ height: '100vh', overflow: 'hidden' }}>
            ...
            <div className="container">
                <div className="leftContainer">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}> {/* Usando Flexbox para alinear en fila */}
                        <img
                            ...
                            // style={{ height: '100px',alignContent:'center', borderRadius: '10px',width: '80%',justifyContent:'center' }} 
                            // style={{ borderRadius: '0%', cursor: 'pointer', width: '50%', height: '45%', objectFit: 'cover', marginLeft: '40px',marginTop:'15px' }}
                ...
                <div className="rightContainer">
                    ...
                    {/* <Button style={{ marginLeft: '980px' }} type="primary" icon={<DownloadOutlined />} size={size}>
                        CV
                    </Button>{mostrarComponente && <Descargadev1/>} */}
