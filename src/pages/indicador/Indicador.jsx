...
const Indicador = () => {
  ...
  const [proyectos, setProyectos] = useState([
    ...
    },
    {
      ...
      avance: 40,
      actividades: [
        { nombre: 'Módulo 1', avance: 30 },
        { nombre: 'Módulo 2', avance: 50 },
        { nombre: 'Módulo 2', avance: 0 },
      ],
    },
    {
      nombre: 'Victum SGA',
      avance: 60,
      actividades: [
        { nombre: 'Módulo 1', avance: 60 },
        { nombre: 'Módulo 2', avance: 60 },
      ],
    },
    {
      nombre: 'Victum DESK',
    ...
    },
    {
      ...
      avance: 60,
      actividades: [
        { nombre: 'Módulo 1 Interfaz Grafica', avance: 100 },
        { nombre: 'Módulo 1 Funcionalidad', avance: 0 },
        { nombre: 'Módulo 2 Interfaz Grafica', avance: 100 },
        { nombre: 'Módulo 2 Funcionalidad', avance: 0 },
        { nombre: 'Módulo 3 Interfaz Grafica', avance: 100 },
        { nombre: 'Módulo 3 Funcionalidad', avance: 0 },
      ],
    },
    {
      nombre: 'Backoffice',
      ...
      actividades: [
        { nombre: 'Módulo 1 Interfaz Grafica', avance: 100 },
        { nombre: 'Módulo 1 Funcionalidad', avance: 10 },
        { nombre: 'Módulo 2 Interfaz Grafica', avance: 100 },
        { nombre: 'Módulo 2 Funcionalidad', avance: 10 },
        { nombre: 'Módulo 3 Interfaz Grafica', avance: 100 },
        { nombre: 'Módulo 3 Funcionalidad', avance: 10 },
        { nombre: 'Módulo 3 Interfaz Grafica', avance: 0 },
        { nombre: 'Módulo 3 Funcionalidad', avance: 0 },
      ],
    },
  ]);
