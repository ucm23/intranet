...
const myTreeData = {
        ...
        {/* style={{ overflow: 'hidden', overflowX: 'hidden' }}> */}
            ...
            <Link to="/Perfilceo"> {/* El `to` es la ruta a la que deseas navegar */}
                <img className='node__image'
                    ...
                    style={{ borderRadius: '40%', marginRight: '8px',cursor: 'pointer',width: '100%', height: '70'}}/>
                     {/* /*, objectFit: 'cover' }} */}
                
            </Link>
           <span style={{ fontSize: '10px',fontStyle:'bold',fontWeight: 'bold' }}>Guillermina Sámano
                <br></br>
                Dirección General
            </span>
        </div>
    ...
    children: [
        {
            id: '2',
            label: <div className="tree-node" style={{ fontSize: '11px', textAlign: 'middle',height: '60px', fontWeight: 'bold' }}>Desarrollo de Aplicaciones</div>,
            children: [
                {
                    id: '3', label: <div className="tree-node">
                        ...
                        <img className='node__image'
                            ...
                            alt="DEV"
                            style={{ borderRadius: '50%', marginRight: '8px',cursor: 'pointer',width: '100%', height: 'auto', objectFit: 'cover' }}
                        />
                        </Link>
...

    {
        id: '4', label: <div className="tree-node">
            ...
            <img className='node__image'
                ...
                alt="DEV"
                style={{ borderRadius: '50%', marginRight: '8px',cursor: 'pointer',width: '100%',height: '60px',objectFit: 'cover' }}
            />
            </Link>
        ...
        {
            id: '6',
            label: <div className="tree-node" style={{ fontSize: '12px' ,height: '60px',fontWeight: 'bold'}}>Mesa de Ayuda y Soporte</div>,
            children: [{
        ...
        {
            id: '8',
            label: <div className="tree-node" style={{ fontSize: '12px',height: '60px',fontWeight: 'bold' }}>Ciber Seguridad</div>,
            children: [{
                id: '7', label: <div className="tree-node">
                     <Link to="/Perfilceo"> 
                    <img className='node__image'
        ...
        {
            id: '10',
            label: <div className="tree-node" style={{ fontSize: '12px',height: '60px',fontWeight: 'bold' }}>ITS y Telepeaje</div>,
            children: [{
                id: '7', label: <div className="tree-node">
                     <Link to="/Perfilceo"> 
                    <img className='node__image'
        ...
        {
            id: '12',
            label: <div className="tree-node" style={{ fontSize: '12px',height: '60px',fontWeight: 'bold' }}>Contabilidad</div>,
            children: [{
                id: '7', label: <div className="tree-node">
