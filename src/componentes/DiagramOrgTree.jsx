...
const myTreeData = {
    ...
    children: [
        {
            id: '2',
            label: <div className="tree-node" style={{ borderRadius: '10%', fontSize: '14px', height: '80px', fontWeight: 'bold',  }}>Jurídico y Seguridad</div>,
            children: [{
                id: '3',
                label: <div className="tree-node" style={{ borderRadius: '10%', width: '160px', height: '220px', transition: 'box-shadow 0.3s ease' }}>
                    ...
                    <span style={{ borderRadius: '10%', fontSize: '13px', fontWeight: 'bold' }}>Luis Manuel Alfaro R.<br></br>Lic. Jurídico
                    </span>
                </div>
            },
            ],
        ...
        {
            id: '4',
            label: <div className="tree-node">Desarrollo Humano</div>,
            children: [{
        ...
        {
            id: '6',
            label: <div className="tree-node">Calidad</div>,
            children: [{
        ...
        {
            id: '8',
            label: <div className="tree-node">Contabilidad y Finanzas</div>,
            children: [{
        ...
        {
            id: '10',
            label: <div className="tree-node">Admon y Cobranza</div>,
            children: [{
        ...
        {
            id: '12',
            label: <div className="tree-node">SAP</div>,
            children: [
                {
