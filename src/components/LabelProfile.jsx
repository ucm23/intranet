...
const LabelProfile = ({ information_user, collapsed, signOut }) => {
            ...
            <List.Item.Meta
                ...
                avatar={
                    <Avatar size='default' className='list-item-meta-avatar list-item-meta-title' style={{ marginRight: collapsed ? 7 : 0 }}>
                        {first_name.charAt(0)}{last_name && last_name.charAt(0)}
                    </Avatar>
                }
        ...
        <Menu style={{ zIndex: 1000 }}>
            ...
            <MenuList className='menu-lis-profile-sider'  style={{ position: 'static', zIndex: 1000 }}>
                <div className='menu-list-profile-header'>
                    <Avatar size='large' className='list-item-meta-avatar list-item-meta-title'>{first_name.charAt(0)}{last_name && last_name.charAt(0)}</Avatar>
